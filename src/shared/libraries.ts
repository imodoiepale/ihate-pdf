...
export const PARSER_LIBRARIES: ParserLibrary[] = [
  {
    ...
    notes: 'Default Analyze engine in i hate pdf when `import pymupdf` works. Measured ~5 ms on an 8-page digital PDF in this environment.',
    detectKey: 'pymupdf'
  },
  {
    id: 'markitdown',
  ...
  },
  {
    ...
    notes: 'Installed with i hate pdf when pip is available. Complements PyMuPDF `find_tables()`.',
  ...
  },
  {
    ...
    notes:
      'This is the product commonly misheard as “Razer / Extract”. i hate pdf implements the same *idea* locally: Parse (Analyze PDF) + Extract (Bank / M-Pesa / Invoice / Extract anything). Point Settings → OpenAI-compatible at a Reducto-compatible proxy if you have a key; we do not upload PDFs by default.',
    detectKey: 'reducto'
  },
  {
    id: 'azure-di',
  ...
  },
  {
    ...
    notes: 'i hate pdf Extract anything does the local equivalent: regex/entities + optional BYO LLM schema fill.',
  ...
  },
  {
    ...
    speed: 'Seconds per scanned page. Capped in i hate pdf.',
  ...
  },
  {
    ...
    what: 'Production OCR PDF writer. The OCR PDF tool in i hate pdf is the lightweight cousin.',
    notes: 'Optional. Run OCR PDF in i hate pdf, then Analyze / extract.',
    detectKey: 'ocrmypdf'
  },
  {
    id: 'textract',
  ...
  },
  {
    ...
    notes: 'Not bundled. i hate pdf already indexes chunks on disk for Ask PDF.',
    detectKey: 'ragie'
  },
  {
    id: 'tika',
  ...
  },
  {
    ...
    notes: 'Optional. i hate pdf ships Tesseract; these are upgrades you can install yourself.',
    detectKey: 'paddleocr'
  }
]
